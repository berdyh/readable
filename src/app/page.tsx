...
} from "./components/pdf/PdfViewerWithHighlights";
import FigureCallouts, {
  type FigureCallout,
} from "./components/pdf/FigureCallouts";
import SummaryPanel, {
  type SummaryNote,
} from "./components/summary/SummaryPanel";
import type { QuestionSelection } from "@/server/qa/types";
import { ResearchEditor } from "./components/editor/ResearchEditor";

const DEMO_PDF_URL = "https://arxiv.org/pdf/1706.03762.pdf";
const DEMO_PAPER_ID = "arxiv:1706.03762";
...
export default function Home() {
  ...
  const handlePdfSelection = useCallback(
    ...
    [setChatDraft, setMobilePane, setSelection, setStatusMessage],
  );
