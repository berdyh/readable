...
| [`editor-architecture.md`](./editor-architecture.md) | Editor internals. **Known stale** — it describes a component tree that has since been restructured. Pending a rewrite; trust the code over this file. |
